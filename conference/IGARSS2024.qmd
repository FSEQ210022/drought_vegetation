...
For the SPI, in the macrozones "norte chico", "central", and "sur" the trend decrease with the time scales of the index. Showing that at longer scales (e.g, 36 months) it reaches a trend of -0.056 (z-score) per decade (@fig-trendSPI). In the case of the AED measured by the EDDI. It shows a positive trend, caused by a increase on AED. The trend on EDDI reaches 0.053 per decade from the macrozones "norte grande" and "norte chico".
