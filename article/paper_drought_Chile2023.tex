...
\hypersetup{
  pdftitle={Drought indices of water demand and supply and their impact on LULCC in Chile from ERA5-Land and MODIS},
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, breakable, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced, interior hidden]}{\end{tcolorbox}}\fi
...
changes in land cover macroclasses (see
...
persistance of the Mega Drought \citep{Garreaud2017}. Despite we used
the persistance mask for vegetations's trend analysis, the cropland,
which is the most water-demand type, showed a decrease trend in ``Norte
Chico'' and ``Centro.'' Also, there was an increase in barren land for
both types. These changes are associated with a decrease in water demand
from vegetation. On the other hand, for ``Norte Chico'' and ``Centro,''
our results show a decrease in trends of water supply (SPI and SSI),
which are higher at larger time scales and consequently impact the
hydrological system. We claim that what occurred in central Chile defies
findings made at the global level
\citep{Vicente-Serrano2021, Kogan2020}, demonstrating that a constant
decrease in water supply rather than an increase in water demand (i.e.,
irrigated crops) is the main cause of the hydrological drought. Finally,
central Chile has shown a diminishment in vegetation productivity for
all macroclasses, mainly attributed to variation in water supply, i.e.,
precipitation, which could be strengthened by an increase in water
demand by, for example, irrigated crops.

1.- Respecto a lo que indica \citep{Vicente-Serrano2022}, de que el
...
\citep{Chen2022}: Assessing the impact of drought-land cover change on
global vegetation greenness and productivity

\citep{Kogan2020}: muestra que la sequía no se ha intensificado ni
expandido a nivel global, por 38 años.
...
China, indicates that forests showed higher drought resistance.
\citep{Xiao2023}, using Vegetation Optical Depth (VOD), kNDVI, and EVI,
evaluates ecosystem resistance, showing that, compared to croplands,
ecosystems with a higher proportion of forests are more resilient to
severe droughts. They attribute the difference to a deeper rooting depth
of trees, a higher water storage capacity, and different water use
strategies between forest and cropland \citep{Xiao2023}. Despite our
insights, \citep{Venegas2022}, who studied sclerophyllous populations,
indicates that the trees experienced a general decline in growth, and
the natural dynamics of their forests may have been altered, mainly due
to the cumulative effects of the unprecedented drought (i.e.,
hydrological drought). Nonetheless, sclerophyllous forest is not the
predominant surface within the forest macroclass used in this study.
...
\citep{Fathi-Taperasht2022}: muestra que bosques son más resilentes a la
sequía en India.

\citep{Wu2024}: evalua la perdida de vegetación en diferentes tipos de
uso de suelo. Muestra que bosques son más resilentes y cultivos y
pastizales, los menos.

\citep{Jiang2020}: impacto de la sequía en landcover en China.
