...
\hypersetup{
  pdftitle={Multi-temporal drought and its effects on land cover change and vegetation productivity in continental Chile},
  pdfauthor={Francisco Zambrano; Anton Vrieling; Francisco Fernández; Francisco Meza; Iongel Duran-Llacer; Alejandro Venegas-González; Nicolas Raab; Dylan Craven},
...
\begin{frontmatter}
\title{Multi-temporal drought and its effects on land cover change and
