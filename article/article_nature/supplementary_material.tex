...
\begin{frontmatter}
\title{Supplementary Material \\\large{Shifts in water supply and demand
drive land cover change across Chile} }
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig_errorbar_resample_random_forest_trends_Forest_norte grande.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{figs/fig_errorbar_resample_random_forest_trends_Cropland_norte grande.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{figs/heatmap_trends_zcNDVI_macro_landcover.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{figs/map_r2_NPP_vs_zcNDVI.png}
...
\includegraphics[width=0.5\textwidth,height=\textheight]{figs/heatmap_r2_npp_vs_zcndvi_per_landcover.png}
