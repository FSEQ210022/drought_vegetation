...
author:
  - name: Francisco Zambrano
    ...
    affiliation: Hemere Centro de Observación de la Tierra,Universidad Mayor
...
In 2021, the sixth assessment report (AR6) from the working group I of the IPCC was released [@IPCC2021]. Chapter 11 [@IPCCCH112021] indicates that human-induced greenhouse gas emissions have increased the frequency and/or intensity of some weather and climate extremes. The evidence has been strengthened since AR5 [@IPCC2013]. There is high confidence that the increasing global warning can expand the land area affected by increasing drought frequency and severity [@IPCCCH112021]. Chile has been facing a persistent rainfall deficit lasting for more than ten years [@Garreaud2017] which has impacted the hydrological system [@Boisier2018], and consequently the vegetation development [@Zambrano2020].   
...
## zcNDVI and cluster zones

## Landcover change and persistence

## Vegetation Cover

## Evapotranspiration, Soil moisture and water storage
...
## zcNDVI and cluster zones
<!-- \begin{figure}[H] -->
<!-- \includegraphics[width=\textwidth]{../figs/map_zcNDVI_ts_clusters.png} -->
<!-- \caption{ } -->
<!-- \end{figure} -->

## Landcover Change and persistent


```{r,echo=FALSE,fig.width =10,fig.pos='H'}
...
<!-- \begin{figure}[H] -->
<!-- \centering -->
<!-- \includegraphics[width=\textwidth]{../output/figs/LC_perZoneAndCluster.png} -->
<!-- \caption{ } -->
<!-- \end{figure} -->

## SPI, AED, and ET

## SM and Total Storage
